		...
		<main class="Container">
			<div class="watch-banner">
				<div class="banner-content">
					<h2>Stay Connected, Stay Active<br>Discover smartwatches designed for everyday life, fitness, and productivity.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Watch'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Watch products found.</p>';
					} else {
