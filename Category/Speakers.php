...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="speakers-banner">
				<div class="banner-content">
					<h2>Powerful Sound, Anywhere<br>Discover immersive audio for your home, workspace, and entertainment.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Speakers'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Speakers products found.</p>';
					} else {
