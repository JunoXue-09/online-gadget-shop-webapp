...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="oppo-banner">
				<div class="banner-content">
					<h2>CO-ENGINEERED WITH HASSELBLAD:<br>Elevate Your Photography with the New Oppo Find Series</h2>
					<p>Experience Masterful Design & Cinematic Imaging. Shop Now.</p>
				</div>
			</div>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Oppo'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Oppo products found.</p>';
					} else {
