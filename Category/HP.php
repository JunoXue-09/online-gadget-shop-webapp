		...
		<main class="Container">
			<div class="hp-banner">
				<div class="banner-content">
					<h2>HP SPECTRE: ELEGANT DESIGN. UNCOMPROMISING CREATIVITY.<br>AI-accelerated performance and stunning OLED displays.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'HP'";
