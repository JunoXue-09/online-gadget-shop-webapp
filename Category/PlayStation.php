...
<body>
	<div class="contentWrapper">
		...
		<main class="Container">
			<div class="playstation-banner">
				<div class="banner-content">
					<h2>Enter a New Era of Gaming<br>Discover consoles, controllers, accessories, and immersive gaming experiences.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'PlayStation'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No PlayStation products found.</p>';
					} else {
