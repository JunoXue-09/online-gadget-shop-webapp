...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="lenovo-banner">
				<div class="banner-content">
					<h2>LENOVO THINKPAD: LEGENDARY RELIABILITY. UNMATCHED INNOVATION.<br>AI-enhanced security and stunning 2.8K OLED displays.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Lenovo'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Lenovo products found.</p>';
					} else {
