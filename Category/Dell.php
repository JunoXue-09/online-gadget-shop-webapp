...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="dell-banner">
				<div class="banner-content">
					<h2>DELL PRECISION: INTELLIGENCE MEETS INCREDIBLE POWER.<br>AI-ready performance and stunning PremierColor displays.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Dell'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Dell products found.</p>';
					} else {
