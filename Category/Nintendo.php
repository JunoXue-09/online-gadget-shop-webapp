...
<body>
	<div class="contentWrapper">
		...
		<main class="Container">
			<div class="nintendo-banner">
				<div class="banner-content">
					<h2>Play Your Way<br>Discover consoles, games, controllers, and accessories for everyone.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Nintendo'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Nintendo products found.</p>';
					} else {
