...
<body>
	<div class="contentWrapper">
		...
		<main class="Container">
			<div class="xbox-banner">
				<div class="banner-content">
					<h2>Power Your Gaming Experience<br>Discover consoles, controllers, accessories, and games built for immersive entertainment.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'XBox'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No XBox products found.</p>';
					} else {
