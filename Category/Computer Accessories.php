		...
		<main class="Container">
			<div class="accessories-banner">
				<div class="banner-content">
					<h2>Computer Accessories<br>Enhance Your Digital Experience.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Computer Accessories'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Computer Accessories products found.</p>';
					} else {
