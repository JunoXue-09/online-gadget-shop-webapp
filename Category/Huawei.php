		...
		<main class="Container">
			<div class="huawei-banner">
				<div class="banner-content">
					<h2>UNLOCK THE INNOVATION:<br>Pre-Order the All-New Huawei Flagship Series</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Huawei'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Huawei products found.</p>';
					} else {
