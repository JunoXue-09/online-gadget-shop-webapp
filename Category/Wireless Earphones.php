...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="wireless-banner">
				<div class="banner-content">
					<h2>Sound Without Limits<br>Experience clear audio, seamless connectivity, and comfortable listening wherever you go.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Wireless Earphones'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Wireless Earphones products found.</p>';
					} else {
