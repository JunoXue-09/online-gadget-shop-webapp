		...
		<main class="Container">
			<div class="macbook-banner">
				<div class="banner-content">
					<h2>MACBOOK: PEAK PERFORMANCE, REIMAGINED.<br>Peak M3 performance and stunning displays.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'MacBook'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No MacBook products found.</p>';
					} else {
