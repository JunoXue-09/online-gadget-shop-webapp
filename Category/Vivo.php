...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="vivo-banner">
				<div class="banner-content">
					<h2>CAPTURE BEYOND LIMITS:<br>Explore the All-New Vivo Flagship Series & Special Deals</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Vivo'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Vivo products found.</p>';
					} else {
