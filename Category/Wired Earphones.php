...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="wired-banner">
				<div class="banner-content">
					<h2>Pure Sound, Simple Connection<br>Enjoy reliable audio with a classic wired connection.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Wired Earphones'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Wired Earphones products found.</p>';
					} else {
