...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="xiaomi-banner">
				<div class="banner-content">
					<h2>CAPTURE THE EPIC:<br>Pre-Order the All-New Xiaomi Flagship Series</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Xiaomi'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Xiaomi products found.</p>';
					} else {
