...
<body>
    <div class="contentWrapper">
		...
		<main class="Container">
			<div class="asus-banner">
				<div class="banner-content">
					<h2>ASUS ZENBOOK: UNCOMPROMISINGLY THIN. INCREDIBLY POWERFUL.<br>Intel Core Ultra power and OLED brilliance.</h2>
			...
			<?php
				...
				if (!$conn) {
					...
					$sql = "SELECT * FROM product WHERE category = 'Asus'";
					...
					if (!$result || mysqli_num_rows($result) === 0) {
						echo '<p>No Asus products found.</p>';
					} else {
