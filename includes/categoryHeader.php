<script src="searchFunction.js"></script>
    ...
    <div class="user-actions">
            ...
            <?php endif; ?>
            <a href="../Pages/shoppingCart.php" class="action-item">Basket<?php echo !empty($_SESSION['cart']) ? ' (' . count($_SESSION['cart']) . ')' : ''; ?></a>
        </div>
    </div>
  </div>
    ...
    <nav class="header-nav">
        ...
        <a href="../Pages/gamingList.php">Gaming</a>
        <a href="../Pages/phoneList.php">Phones</a>
        <a href="../Pages/computerList.php">Computing</a>
        <a href="../Pages/accessoriesList.php">Accessories</a>
		<a href="../Pages/profile.php" class="nav-link">My Profile / Orders</a>
    </nav>
    </header>
